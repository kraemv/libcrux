...
/// A portable cSHAKE128 implementation.
#[inline(always)]
pub fn cshake128(digest: &mut [u8], data: &[u8]) {
    keccak1::<168, 0x4u8>(data, digest);
}
...
/// A portable cSHAKE128 implementation.
#[inline(always)]
pub fn cshake256(digest: &mut [u8], data: &[u8]) {
    keccak1::<136, 0x4u8>(data, digest);
}
